...
$id=$_REQUEST['id'];
$result = mysqli_query($con, "SELECT image FROM registration where id = '$id'");
...
<?php 
		 $ret= mysqli_query($con,"SELECT * FROM registration where id = '$id'");
...
<tr>
<td width="12%" valign="top" class="heading">Aadhar No.: </td>
<td class="comb-value1"><?php echo $row['aadhar'];?></td>
</tr>
