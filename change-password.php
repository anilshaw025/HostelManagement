...
if(isset($_POST['changepwd']))
{
  ...
  $np=$_POST['newpassword'];
	...
	$sql=mysqli_query($mysqli,"select password from userregistration where password='$op' && email='$email'");
	$row_cnt=mysqli_fetch_array($sql);
	
	
	if($row_cnt>0)
	{
		$con=mysqli_query($mysqli,"update userregistration set password='$np',passUdateDate='$udate'  where email='$email'");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 style="margin-top: 4%" class="page-title">Change Password </h2>
...
$cons=mysqli_query($mysqli,"select passUdateDate from userregistration where id='$id'");
